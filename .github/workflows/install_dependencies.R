install.packages(c('dplyr','purrr','covr','readr','tidyr','webshot','spelling','readxl','data.table','gridtext','ggtext','tidyselect','testthat','rmarkdown','pkgdown','ggplot2','shiny','shinyTree','shinyjs','randtoolbox','interp','writexl','tictoc','pkgload'), repos = 'http://cran.us.r-project.org', type='win.binary')
